...
// AD  0-3V
#define  BSP_GPIOC_ADC1_IN10                   DEF_BIT_00    // 电池电压
#define  BSP_GPIOC_ADC1_IN11                   DEF_BIT_01    // 电池电流
#define  BSP_GPIOC_ADC1_IN12                   DEF_BIT_02    // 迎角
#define  BSP_GPIOC_ADC1_IN13                   DEF_BIT_03    // 侧滑角


// PowerStatus
#define  BSP_GPIOE_BAT_IN                      DEF_BIT_10    // 0有效，输入，第一选择
#define  BSP_GPIOE_SERVO_IN                    DEF_BIT_12    // 0有效，输入，第二选择
#define  BSP_GPIOE_VBUS_IN                     DEF_BIT_15    // 0有效，输入，第三选择


// OnBoard LED
#define  BSP_GPIOD_LEDBlue_OUT                 DEF_BIT_03    // 0有效，输出
#define  BSP_GPIOD_LEDRed_OUT                  DEF_BIT_04    // 0有效，输出


// Button & LED & Buzzer
#define  BSP_GPIOA_Button_IN                   DEF_BIT_05    // 1有效，输入
#define  BSP_GPIOA_LED_TIM13_CH1               DEF_BIT_06    // PWM 1有效，输出
#define  BSP_GPIOA_Buzzer_TIM14_CH1            DEF_BIT_07    // PWM 1有效，输出
...
// timer 5,6,7,8，未使用，可用作通用定时器
// Counter  32bit timer
#define  BSP_GPIOA_TIM2_ETR                    DEF_BIT_15    // 发动机转速测量
...
#define  BSP_GPIOC_SBUS_OUT                    DEF_BIT_14    // 0使能SBUS--负逻辑，1使能DSMx--正逻辑


// UART
#define  BSP_GPIOA_UART4_TX                    DEF_BIT_00    // RS232 RX，with UART7 
#define  BSP_GPIOA_UART4_RX                    DEF_BIT_01    // RS232 TX，with UART7 
...
#define  BSP_GPIOD_USART2_TX                   DEF_BIT_05    // GPS模组，with I2C1
#define  BSP_GPIOD_USART2_RX                   DEF_BIT_06


// I2C
#define  BSP_GPIOB_I2C1_SCL                    DEF_BIT_06    // GPS模组 & 全色LED，with USART2
...
// SPI
#define  BSP_GPIOD_SPI1_CS0_OUT                DEF_BIT_07    // 0有效，输出，NVM
#define  BSP_GPIOB_SPI1_SCK                    DEF_BIT_03
#define  BSP_GPIOB_SPI1_MISO                   DEF_BIT_04
#define  BSP_GPIOB_SPI1_MOSI                   DEF_BIT_05

#define  BSP_GPIOE_SPI4_CS0_OUT                DEF_BIT_04    // 0有效，输出，MPU6500
#define  BSP_GPIOE_SPI4_CS1_OUT                DEF_BIT_03    // 0有效，输出，HMC5983
#define  BSP_GPIOC_SPI4_CS2_OUT                DEF_BIT_13    // 0有效，输出，BMP280
...
// SDIO  10k全上拉
#define  BSP_GPIOC_SDIO_D0                     DEF_BIT_08    // SD卡
...
// USB FS
#define  BSP_GPIOA_FS_VBUS_IN                  DEF_BIT_09    // 1有效，输入
...
// IO操作
// ====================
#define  BSP_LEDBlue_ON                       (GPIOD->BSRRH = BSP_GPIOD_LEDBlue_OUT)  // 0
#define  BSP_LEDBlue_OFF                      (GPIOD->BSRRL = BSP_GPIOD_LEDBlue_OUT)  // 1
#define  BSP_LEDBlue_Toggle                    BSP_LED_Toggle (0)                     // 反转
 
#define  BSP_LEDRed_ON                        (GPIOD->BSRRH = BSP_GPIOD_LEDRed_OUT)   // 0
#define  BSP_LEDRed_OFF                       (GPIOD->BSRRL = BSP_GPIOD_LEDRed_OUT)   // 1
#define  BSP_LEDRed_Toggle                     BSP_LED_Toggle (1)                     // 反转

#define  BSP_RCIN_SBUS                        (GPIOC->BSRRH = BSP_GPIOC_SBUS_OUT)     // 0   RCIN
#define  BSP_RCIN_DSMX                        (GPIOC->BSRRL = BSP_GPIOC_SBUS_OUT)     // 1

#define  BSP_SPI1_CS0_EN                      (GPIOD->BSRRH = BSP_GPIOD_SPI1_CS0_OUT) // 0   NVM
#define  BSP_SPI1_CS0_DIS                     (GPIOD->BSRRL = BSP_GPIOD_SPI1_CS0_OUT) // 1

#define  BSP_SPI4_CS0_EN                      (GPIOE->BSRRH = BSP_GPIOE_SPI4_CS0_OUT) // 0   MPU6500
#define  BSP_SPI4_CS0_DIS                     (GPIOE->BSRRL = BSP_GPIOE_SPI4_CS0_OUT) // 1

#define  BSP_SPI4_CS1_EN                      (GPIOE->BSRRH = BSP_GPIOE_SPI4_CS1_OUT) // 0   HMC5983
#define  BSP_SPI4_CS1_DIS                     (GPIOE->BSRRL = BSP_GPIOE_SPI4_CS1_OUT) // 1

#define  BSP_SPI4_CS2_EN                      (GPIOC->BSRRH = BSP_GPIOC_SPI4_CS2_OUT) // 0   BMP280
#define  BSP_SPI4_CS2_DIS                     (GPIOC->BSRRL = BSP_GPIOC_SPI4_CS2_OUT) // 1
