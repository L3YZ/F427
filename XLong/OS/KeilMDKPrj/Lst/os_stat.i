#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_stat.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_stat.c"
...
#line 80 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_stat.c"
    ...
    while (p_tcb != (OS_TCB *)0) {                           
        ...
        p_tcb->CyclesStart      =  (CPU_TS)CPU_TS_TmrRd();
...
#line 207 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_stat.c"
...
void  OS_StatTask (void  *p_arg)
{
    ...
    (void)&p_arg;                                            
    while (OSStatTaskRdy != 1u) {
        OSTimeDly(2u * OSCfg_StatTaskRate_Hz,                
                  0x00u,
                  &err);
    }
    OSStatReset(&err);                                       
    ...
    while (1u) {
        ...
        do { do { cpu_sr = CPU_SR_Save(); } while (0); } while (0);                                
        OSStatTaskCtrRun   = OSStatTaskCtr;                  
        OSStatTaskCtr      = (OS_TICK)0;                     
        do { do { CPU_SR_Restore(cpu_sr); } while (0); } while (0);
        ...
        while (p_tcb != (OS_TCB *)0) {                       
            ...
            cycles_total          += p_tcb->CyclesTotalPrev; 
        ...
        if (OSStatResetFlag == 1u) {                   
            OSStatResetFlag  = 0u;
            OSStatReset(&err);
        }

        ts_end = (CPU_TS)CPU_TS_TmrRd() - ts_start;                     
...
void  OS_StatTaskInit (OS_ERR  *p_err)
{
#line 482 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_stat.c"

    OSStatTaskCtr    = (OS_TICK)0;
    OSStatTaskCtrRun = (OS_TICK)0;
    OSStatTaskCtrMax = (OS_TICK)0;
    OSStatTaskRdy    = (CPU_BOOLEAN)(0u);                     
    OSStatResetFlag  = 0u;
