#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"
...
void  OSTmrCreate (OS_TMR               *p_tmr,
                   ...
                   OS_ERR               *p_err)
{
#line 130 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"

#line 137 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"

#line 144 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"
    ...
    p_tmr->State          = (OS_STATE           )(OS_STATE)(1u);      

    p_tmr->Type           = (OS_OBJ_TYPE        )(OS_OBJ_TYPE)(((CPU_INT32U)((CPU_INT08U)('T')) << (0u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('M')) << (1u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('R')) << (2u * 8u)) | ((CPU_INT32U)((CPU_INT08U)(' ')) << (3u * 8u)));
...
#line 238 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"

#line 245 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"
    ...
    if (p_tmr->Type != (OS_OBJ_TYPE)(((CPU_INT32U)((CPU_INT08U)('T')) << (0u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('M')) << (1u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('R')) << (2u * 8u)) | ((CPU_INT32U)((CPU_INT08U)(' ')) << (3u * 8u)))) {                    
...
#line 339 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"

#line 346 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"
...
#line 448 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"

#line 455 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"
...
#line 558 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"

#line 565 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"
...
#line 649 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"

#line 656 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"
...
void  OS_TmrClr (OS_TMR  *p_tmr)
{
    p_tmr->State          = (OS_STATE)(0u);             

    p_tmr->Type           = (OS_OBJ_TYPE)(((CPU_INT32U)((CPU_INT08U)('N')) << (0u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('O')) << (1u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('N')) << (2u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('E')) << (3u * 8u)));
...
void  OS_TmrInit (OS_ERR  *p_err)
{
#line 850 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tmr.c"
    ...
    OSTaskCreate((OS_TCB     *)&OSTmrTaskTCB,
                 ...
                 (OS_TICK     )0,
                 (void       *)0,
                 (OS_OPT      )((OS_OPT)(0x0001u) | (OS_OPT)(0x0002u) | (OS_OPT)(0x0008u)),
                 (OS_ERR     *)p_err);
}
...
void  OS_TmrTask (void  *p_arg)
{
    ...
    while (1u) {
        ...
        ts_delta = (CPU_TS)CPU_TS_TmrRd() - ts_start;                       
        OS_TmrUnlock();
