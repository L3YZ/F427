#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
...
#line 89 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"

#line 96 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"

#line 103 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
    ...
    p_q->Type    = (OS_OBJ_TYPE)(((CPU_INT32U)((CPU_INT08U)('Q')) << (0u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('U')) << (1u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('E')) << (2u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('U')) << (3u * 8u)));                            
...
#line 195 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"

#line 202 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
    ...
    if (p_q->Type != (OS_OBJ_TYPE)(((CPU_INT32U)((CPU_INT08U)('Q')) << (0u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('U')) << (1u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('E')) << (2u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('U')) << (3u * 8u)))) {                        
...
#line 322 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"

#line 329 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
...
#line 421 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"

#line 431 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
...
#line 631 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"

#line 638 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
...
#line 765 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
    ...
    switch (opt) {                                           
        case (OS_OPT)(0x0000u):
        case (OS_OPT)(0x0010u):
        case (OS_OPT)(0x0000u) | (OS_OPT)(0x0200u):
        case (OS_OPT)(0x0010u) | (OS_OPT)(0x0200u):
        case (OS_OPT)(0x0000u) | (OS_OPT)(0x8000u):
        case (OS_OPT)(0x0010u) | (OS_OPT)(0x8000u):
        case (OS_OPT)(0x0000u) | (OS_OPT)(0x0200u) | (OS_OPT)(0x8000u):
        case (OS_OPT)(0x0010u) | (OS_OPT)(0x0200u) | (OS_OPT)(0x8000u):
             break;
...
#line 822 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
    OS_QPost(p_q,
             p_void,
             msg_size,
             opt,
...
void  OS_QClr (OS_Q  *p_q)
{
    (void)OS_MsgQFreeAll(&p_q->MsgQ);                        

    p_q->Type    =  (OS_OBJ_TYPE)(((CPU_INT32U)((CPU_INT08U)('N')) << (0u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('O')) << (1u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('N')) << (2u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('E')) << (3u * 8u)));                        
...
void  OS_QInit (OS_ERR  *p_err)
{
#line 949 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_q.c"
                ...
                OS_ERR       *p_err)
{
    ...
    if (p_pend_list->NbrEntries == (OS_OBJ_QTY)0) {          
        if ((opt & (OS_OPT)(0x0010u)) == (OS_OPT)0) {         
            post_type = (OS_OPT)(0x0000u);
        } else {
            post_type = (OS_OPT)(0x0010u);
        }
        OS_MsgQPut(&p_q->MsgQ,                               
                   p_void,
                   msg_size,
    ...
    if ((opt & (OS_OPT)(0x0200u)) != (OS_OPT)0) {              
        cnt = p_pend_list->NbrEntries;                       
    } else {
        cnt = (OS_OBJ_QTY)1;                                 
    }
