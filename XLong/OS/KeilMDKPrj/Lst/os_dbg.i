#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_dbg.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_dbg.c"





CPU_INT08U  const  OSDbg_DbgEn                 = 1u;                 
...
CPU_INT08U  const  OSDbg_ArgChkEn              = 1u;
CPU_INT08U  const  OSDbg_AppHooksEn            = 1u;

CPU_INT32U  const  OSDbg_EndiannessTest        = 0x12345678LU;                  

CPU_INT08U  const  OSDbg_CalledFromISRChkEn    = 0u;

CPU_INT08U  const  OSDbg_FlagEn                = 1u;
OS_FLAG_GRP const  OSDbg_FlagGrp               = { 0u };

CPU_INT08U  const  OSDbg_FlagDelEn             = 1u;
CPU_INT08U  const  OSDbg_FlagModeClrEn         = 1u;
CPU_INT08U  const  OSDbg_FlagPendAbortEn       = 1u;
CPU_INT16U  const  OSDbg_FlagGrpSize           = sizeof(OS_FLAG_GRP);           
CPU_INT16U  const  OSDbg_FlagWidth             = sizeof(OS_FLAGS);              
#line 74 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_dbg.c"
...
CPU_INT08U  const  OSDbg_ISRPostDeferredEn     = 0u;

OS_MEM      const  OSDbg_Mem                   = { 0u };
CPU_INT08U  const  OSDbg_MemEn                 = 1u;

CPU_INT16U  const  OSDbg_MemSize               = sizeof(OS_MEM);                
...
CPU_INT16U  const  OSDbg_MsgSize               = sizeof(OS_MSG);                
CPU_INT16U  const  OSDbg_MsgPoolSize           = sizeof(OS_MSG_POOL);
CPU_INT16U  const  OSDbg_MsgQSize              = sizeof(OS_MSG_Q);
#line 103 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_dbg.c"


OS_MUTEX    const  OSDbg_Mutex                 = { 0u };
CPU_INT08U  const  OSDbg_MutexEn               = 1u;

CPU_INT08U  const  OSDbg_MutexDelEn            = 1u;
CPU_INT08U  const  OSDbg_MutexPendAbortEn      = 1u;
CPU_INT16U  const  OSDbg_MutexSize             = sizeof(OS_MUTEX);              
...
CPU_INT08U  const  OSDbg_ObjTypeChkEn          = 1u;


CPU_INT08U  const  OSDbg_PendMultiEn           = 0u;
...
CPU_INT16U  const  OSDbg_PrioMax               = 64u;               
CPU_INT16U  const  OSDbg_PrioTblSize           = sizeof(OSPrioTbl);

CPU_INT16U  const  OSDbg_PtrSize               = sizeof(void *);                


OS_Q        const  OSDbg_Q                     = { 0u };
CPU_INT08U  const  OSDbg_QEn                   = 1u;

CPU_INT08U  const  OSDbg_QDelEn                = 1u;
CPU_INT08U  const  OSDbg_QFlushEn              = 1u;
CPU_INT08U  const  OSDbg_QPendAbortEn          = 1u;
CPU_INT16U  const  OSDbg_QSize                 = sizeof(OS_Q);                  
#line 145 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_dbg.c"


CPU_INT08U  const  OSDbg_SchedRoundRobinEn     = 0u;


OS_SEM      const  OSDbg_Sem                   = { 0u };
CPU_INT08U  const  OSDbg_SemEn                 = 1u;

CPU_INT08U  const  OSDbg_SemDelEn              = 1u;
CPU_INT08U  const  OSDbg_SemPendAbortEn        = 1u;
CPU_INT08U  const  OSDbg_SemSetEn              = 1u;
CPU_INT16U  const  OSDbg_SemSize               = sizeof(OS_SEM);                
#line 163 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_dbg.c"


CPU_INT16U  const  OSDbg_RdyList               = sizeof(OS_RDY_LIST);
CPU_INT32U  const  OSDbg_RdyListSize           = sizeof(OSRdyList);             

CPU_INT08U  const  OSDbg_StkWidth              = sizeof(CPU_STK);

CPU_INT08U  const  OSDbg_StatTaskEn            = 1u;
CPU_INT08U  const  OSDbg_StatTaskStkChkEn      = 1u;

CPU_INT08U  const  OSDbg_TaskChangePrioEn      = 1u;
CPU_INT08U  const  OSDbg_TaskDelEn             = 1u;
CPU_INT08U  const  OSDbg_TaskQEn               = 1u;
CPU_INT08U  const  OSDbg_TaskQPendAbortEn      = 1u;
CPU_INT08U  const  OSDbg_TaskProfileEn         = 1u;
CPU_INT16U  const  OSDbg_TaskRegTblSize        = 1u;
CPU_INT08U  const  OSDbg_TaskSemPendAbortEn    = 1u;
CPU_INT08U  const  OSDbg_TaskSuspendEn         = 1u;


CPU_INT16U  const  OSDbg_TCBSize               = sizeof(OS_TCB);                

CPU_INT16U  const  OSDbg_TickListSize          = sizeof(OS_TICK_LIST);

CPU_INT08U  const  OSDbg_TimeDlyHMSMEn         = 1u;
CPU_INT08U  const  OSDbg_TimeDlyResumeEn       = 1u;
...
CPU_INT08U  const  OSDbg_TmrEn                 = 1u;

CPU_INT08U  const  OSDbg_TmrDelEn              = 1u;
...
CPU_INT16U  const  OSDbg_VersionNbr            = 30404u;
...
#line 246 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_dbg.c"
