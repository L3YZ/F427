#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"
...
#line 96 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"

#line 103 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"
...
#line 228 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"

#line 235 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"
    ...
    opt_time = opt & ((OS_OPT)(0x00u | ((OS_OPT)0x02u) | ((OS_OPT)0x08u) | ((OS_OPT)0x04u)));                       
    switch (opt_time) {
        case 0x00u:
        case ((OS_OPT)0x02u):
        case ((OS_OPT)0x08u):
    ...
    opt_invalid = ((((opt) & (~(0x00u | ((OS_OPT)0x02u) | ((OS_OPT)0x08u) | ((OS_OPT)0x04u) | ((OS_OPT)0x10u)))) == 0u) ? (0u ) : (1u));
    if (opt_invalid == 1u) {
       *p_err = OS_ERR_OPT_INVALID;
        return;
    }

    opt_non_strict = (((((opt) & (((OS_OPT)0x10u))) == (((OS_OPT)0x10u))) && ((((OS_OPT)0x10u)) != 0u)) ? (1u) : (0u));
    if (opt_non_strict != 1u) {
...
#line 368 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"

#line 375 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"
...
#line 476 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"
...
#line 513 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"
...
#line 557 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_time.c"
