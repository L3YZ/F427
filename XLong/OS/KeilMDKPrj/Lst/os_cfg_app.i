#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_cfg_app.c"
...
#line 39 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_cfg_app.c"
...
#line 40 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_cfg_app.c"
...
CPU_STK        OSCfg_ISRStk        [100u];



OS_MSG         OSCfg_MsgPool       [100u];



CPU_STK        OSCfg_StatTaskStk   [100u];


CPU_STK        OSCfg_TickTaskStk   [100u];


CPU_STK        OSCfg_TmrTaskStk    [100u];
...
CPU_STK_SIZE   const  OSCfg_IdleTaskStkLimit     = (CPU_STK_SIZE)((64u * 10u) / 100u);
CPU_STK_SIZE   const  OSCfg_IdleTaskStkSize      = (CPU_STK_SIZE)64u;
CPU_INT32U     const  OSCfg_IdleTaskStkSizeRAM   = (CPU_INT32U  )sizeof(OSCfg_IdleTaskStk);


#line 103 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_cfg_app.c"
...
CPU_STK_SIZE   const  OSCfg_ISRStkSize           = (CPU_STK_SIZE)100u;
...
OS_MSG_SIZE    const  OSCfg_MsgPoolSize          = (OS_MSG_SIZE)100u;
...
OS_PRIO        const  OSCfg_StatTaskPrio         = (OS_PRIO     )11u;
OS_RATE_HZ     const  OSCfg_StatTaskRate_Hz      = (OS_RATE_HZ  )10u;
CPU_STK      * const  OSCfg_StatTaskStkBasePtr   = (CPU_STK    *)&OSCfg_StatTaskStk[0];
CPU_STK_SIZE   const  OSCfg_StatTaskStkLimit     = (CPU_STK_SIZE)((100u * 10u) / 100u);
CPU_STK_SIZE   const  OSCfg_StatTaskStkSize      = (CPU_STK_SIZE)100u;
CPU_INT32U     const  OSCfg_StatTaskStkSizeRAM   = (CPU_INT32U  )sizeof(OSCfg_StatTaskStk);
#line 150 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_cfg_app.c"


CPU_STK_SIZE   const  OSCfg_StkSizeMin           = (CPU_STK_SIZE)64u;


OS_RATE_HZ     const  OSCfg_TickRate_Hz          = (OS_RATE_HZ  )1000u;
OS_PRIO        const  OSCfg_TickTaskPrio         = (OS_PRIO     )1u;
CPU_STK      * const  OSCfg_TickTaskStkBasePtr   = (CPU_STK    *)&OSCfg_TickTaskStk[0];
CPU_STK_SIZE   const  OSCfg_TickTaskStkLimit     = (CPU_STK_SIZE)((100u * 10u) / 100u);
CPU_STK_SIZE   const  OSCfg_TickTaskStkSize      = (CPU_STK_SIZE)100u;
CPU_INT32U     const  OSCfg_TickTaskStkSizeRAM   = (CPU_INT32U  )sizeof(OSCfg_TickTaskStk);



OS_PRIO        const  OSCfg_TmrTaskPrio          = (OS_PRIO     )11u;
OS_RATE_HZ     const  OSCfg_TmrTaskRate_Hz       = (OS_RATE_HZ  )10u;
CPU_STK      * const  OSCfg_TmrTaskStkBasePtr    = (CPU_STK    *)&OSCfg_TmrTaskStk[0];
CPU_STK_SIZE   const  OSCfg_TmrTaskStkLimit      = (CPU_STK_SIZE)((100u * 10u) / 100u);
CPU_STK_SIZE   const  OSCfg_TmrTaskStkSize       = (CPU_STK_SIZE)100u;
CPU_INT32U     const  OSCfg_TmrTaskStkSizeRAM    = (CPU_INT32U  )sizeof(OSCfg_TmrTaskStk);
#line 178 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_cfg_app.c"
...
#line 248 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_cfg_app.c"
