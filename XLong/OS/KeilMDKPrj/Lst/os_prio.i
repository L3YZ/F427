#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_prio.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_prio.c"
...
CPU_DATA   OSPrioTbl[((64u - 1u) / ((4u * 8u)) + 1u)];                      
...
void  OS_PrioInsert (OS_PRIO  prio)
{
    ...
    ix             = prio / (4u * 8u);
    bit_nbr        = (CPU_DATA)prio & ((4u * 8u) - 1u);
    bit            = 1u;
    bit          <<= ((4u * 8u) - 1u) - bit_nbr;
    OSPrioTbl[ix] |= bit;
}
