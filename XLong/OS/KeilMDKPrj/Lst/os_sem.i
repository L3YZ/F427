#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"
...
#line 90 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"

#line 97 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"

#line 104 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"
    ...
    p_sem->Type    = (OS_OBJ_TYPE)(((CPU_INT32U)((CPU_INT08U)('S')) << (0u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('E')) << (1u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('M')) << (2u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('A')) << (3u * 8u)));                        
...
#line 195 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"

#line 202 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"
    ...
    if (p_sem->Type != (OS_OBJ_TYPE)(((CPU_INT32U)((CPU_INT08U)('S')) << (0u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('E')) << (1u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('M')) << (2u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('A')) << (3u * 8u)))) {                    
...
#line 350 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"

#line 360 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"
...
#line 544 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"

#line 551 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"
...
#line 657 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"
    ...
    switch (opt) {                                           
        ...
        case (OS_OPT)(0x0200u):
        case (OS_OPT)(0x0000u)   | (OS_OPT)(0x8000u):
        case (OS_OPT)(0x0200u) | (OS_OPT)(0x8000u):
             break;
...
#line 707 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"





    ctr = OS_SemPost(p_sem,                                  
                     opt,
                     ts,
                     p_err);
...
#line 762 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"

#line 769 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"
...
void  OS_SemClr (OS_SEM  *p_sem)
{
    ...
    p_sem->Type    = (OS_OBJ_TYPE)(((CPU_INT32U)((CPU_INT08U)('N')) << (0u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('O')) << (1u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('N')) << (2u * 8u)) | ((CPU_INT32U)((CPU_INT08U)('E')) << (3u * 8u)));                       

    p_sem->Ctr     = (OS_SEM_CTR)0;                          
    p_sem->TS      = (CPU_TS    )0;                          
...
void  OS_SemInit (OS_ERR  *p_err)
{
#line 917 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_sem.c"
