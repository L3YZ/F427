#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
#line 70 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"

    OSInitHook();                                            

    OSIntNestingCtr                 = (OS_NESTING_CTR)0;     

    OSRunning                       =  (OS_STATE)(0u);  
...
#line 187 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
#line 201 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
void  OSIntExit (void)
{
    ...
    do { cpu_sr = CPU_SR_Save(); } while (0);
    if (OSIntNestingCtr == (OS_NESTING_CTR)0) {              
        do { CPU_SR_Restore(cpu_sr); } while (0);
        return;
    }
    OSIntNestingCtr--;
    if (OSIntNestingCtr > (OS_NESTING_CTR)0) {               
...
#line 372 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
#line 463 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"

#line 470 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
#line 524 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"

#line 531 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
#line 610 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
#line 687 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
void  OSStart (OS_ERR  *p_err)
{
#line 721 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"

    if (OSRunning == (OS_STATE)(0u)) {
        OSPrioHighRdy   = OS_PrioGetHighest();               
        OSPrioCur       = OSPrioHighRdy;
        OSTCBHighRdyPtr = OSRdyList[OSPrioHighRdy].HeadPtr;
        OSTCBCurPtr     = OSTCBHighRdyPtr;
        OSRunning       = (OS_STATE)(1u);
        OSStartHighRdy();                                    
...
CPU_INT16U  OSVersion (OS_ERR  *p_err)
{
#line 760 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
void  OS_IdleTaskInit (OS_ERR  *p_err)
{
#line 831 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
               ...
               OS_TICK        timeout)
{
    ...
    OSTCBCurPtr->PendStatus = (OS_STATUS)( 0u);
    ...
    if (p_obj != (OS_PEND_OBJ *)0) {                          
        ...
        p_pend_data->PendObjPtr = p_obj;                      
        OS_PendDataInit((OS_TCB       *)OSTCBCurPtr,          
                        (OS_PEND_DATA *)p_pend_data,
                        (OS_OBJ_QTY    )1);
                    ...
                    CPU_TS        ts)
{
    switch (p_tcb->TaskState) {
        ...
        case (OS_STATE)( 7u):
             ...
             if (p_tcb->TaskState == (OS_STATE)( 7u)) {
                 OS_TickListRemove(p_tcb);                        
             }
...
void  OS_PendAbort1 (OS_PEND_OBJ  *p_obj,
                     ...
                     CPU_TS        ts)
{
    OS_OBJ_QTY      n_pend_list;                                     
    OS_PEND_DATA   *p_pend_data;



    p_pend_data = p_tcb->PendDataTblPtr;                             
    n_pend_list = p_tcb->PendDataTblEntries;                         
                       ...
                       OS_OBJ_QTY     tbl_size)
{
    ...
    p_tcb->PendDataTblEntries = tbl_size;                    
                         ...
                         OS_TCB       *p_tcb)
{
    ...
    if (p_obj != (OS_PEND_OBJ *)0) {
        p_tcb->DbgNamePtr =  p_obj->NamePtr;                 
        p_pend_list       = &p_obj->PendList;                
                             ...
                             OS_PEND_DATA  *p_pend_data)
{
    ...
    p_pend_data->NextPtr  = p_pend_list->HeadPtr;            
                             ...
                             OS_PEND_DATA  *p_pend_data)
{
    ...
    if (p_pend_list->NbrEntries == (OS_OBJ_QTY)0) {                    
        p_pend_list->NbrEntries = (OS_OBJ_QTY)1;                       
        ...
        while (p_pend_data_next != (OS_PEND_DATA *)0) {                
            ...
            if (prio < p_tcb_next->Prio) {
                ...
                p_pend_data_next = p_pend_data_next->NextPtr;          
            }
        }
        if (p_pend_data_next == (OS_PEND_DATA *)0) {                   
            p_pend_data->NextPtr      = (OS_PEND_DATA *)0;             
...
#line 2481 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
...
#line 2604 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_core.c"
