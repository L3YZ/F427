...
CPU_INT16U  BSP_XLongPWM_GroupPara[]  ={ 55u, 60000u,300u,  
	                                     55u, 60000u,300u,  
		                                 55u, 60000u,300u,  
                                         6u, 60000u,2400u,  
                                         6u, 60000u,2400u,  
...
CPU_INT08U  BSP_XLongPWM_MultiPara[]  ={ 
	                                      5,15,25,15,0u, 0u,  
	                                      5,15,25,15,0u, 0u,  
	                                     10,15,20, 9,1u,0u,  
	                                     10,15,20, 9,1u,0u,  
...
void   BSP_XLong_PWMRefresh(CPU_INT16U channel)
{
	...
	if(channel & 0x01u) 
	{
		if(BSP_XLongPWM_MultiPara[5] == 0u)   	
		{	
           ...
           { 
			   ...
			   {				   
				   sTemp =  BSP_XLongPWM_MultiPara[2] - BSP_XLongPWM_MultiPara[0];  
				   fTemp = (CPU_FP32)sTemp;
				   fTemp = fTemp* BSP_XLongPWM_ChValue[0];                 
				   
				   fTemp = fTemp + (CPU_FP32)BSP_XLongPWM_MultiPara[0];    
				   fTemp = fTemp* BSP_XLongPWM_GroupPara[2];               
		...
		else                                                
		{
           if(BSP_XLongPWM_MultiPara[4] == 0u) 	
		   {
			   ...
			   {
				   sTemp = (BSP_XLongPWM_MultiPara[0] - BSP_XLongPWM_MultiPara[2]) / 2; 
				   fTemp = (CPU_FP32)sTemp;
				   fTemp = fTemp* BSP_XLongPWM_ChValue[0];                 
           ...
           { 
			   ...
			   {				   
				   sTemp =  BSP_XLongPWM_MultiPara[0] - BSP_XLongPWM_MultiPara[2];  
				   fTemp = (CPU_FP32)sTemp;
				   fTemp = fTemp* BSP_XLongPWM_ChValue[0];                 
				   
				   fTemp = fTemp + (CPU_FP32)BSP_XLongPWM_MultiPara[2];    
				   fTemp = fTemp* BSP_XLongPWM_GroupPara[2];               
...
void   BSP_XLong_PWMInit(void)
{
	...
	TIM_TimeBaseStructure.TIM_Prescaler     = BSP_XLongPWM_GroupPara[0]; 
	TIM_TimeBaseStructure.TIM_CounterMode   = ((uint16_t)0x0000);        
	TIM_TimeBaseStructure.TIM_Period        = BSP_XLongPWM_GroupPara[1]; 
	...
	TIM_TimeBaseStructure.TIM_Prescaler     = BSP_XLongPWM_GroupPara[3]; 
	TIM_TimeBaseStructure.TIM_CounterMode   = ((uint16_t)0x0000);        
	TIM_TimeBaseStructure.TIM_Period        = BSP_XLongPWM_GroupPara[4]; 
	TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);              
    TIM_TimeBaseInit(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)),&TIM_TimeBaseStructure);
	
	
	TIM_TimeBaseStructure.TIM_Prescaler     = BSP_XLongPWM_GroupPara[6]; 
	TIM_TimeBaseStructure.TIM_CounterMode   = ((uint16_t)0x0000);        
	TIM_TimeBaseStructure.TIM_Period        = BSP_XLongPWM_GroupPara[7]; 
	TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);              
    TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)),&TIM_TimeBaseStructure);	
	
	
	TIM_TimeBaseStructure.TIM_Prescaler     = BSP_XLongPWM_GroupPara[9]; 
	TIM_TimeBaseStructure.TIM_CounterMode   = ((uint16_t)0x0000);        
	TIM_TimeBaseStructure.TIM_Period        = BSP_XLongPWM_GroupPara[10];
	TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);              
	TIM_TimeBaseStructure.TIM_RepetitionCounter = 0x0;
	TIM_TimeBaseInit(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)),&TIM_TimeBaseStructure);	
	
	
	TIM_TimeBaseStructure.TIM_Prescaler     = BSP_XLongPWM_GroupPara[12];
	TIM_TimeBaseStructure.TIM_CounterMode   = ((uint16_t)0x0000);        
	TIM_TimeBaseStructure.TIM_Period        = BSP_XLongPWM_GroupPara[13];
	TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);              
	TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)),&TIM_TimeBaseStructure);
	
	
	TIM_TimeBaseStructure.TIM_Prescaler     = BSP_XLongPWM_GroupPara[15];
	TIM_TimeBaseStructure.TIM_CounterMode   = ((uint16_t)0x0000);        
	TIM_TimeBaseStructure.TIM_Period        = BSP_XLongPWM_GroupPara[16];
	TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);              
	TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)),&TIM_TimeBaseStructure);		

	
	TIM_TimeBaseStructure.TIM_Prescaler     = BSP_XLongPWM_GroupPara[18];
	TIM_TimeBaseStructure.TIM_CounterMode   = ((uint16_t)0x0000);        
	TIM_TimeBaseStructure.TIM_Period        = BSP_XLongPWM_GroupPara[19];
	TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);              
	TIM_TimeBaseInit(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)),&TIM_TimeBaseStructure);	

	
	TIM_TimeBaseStructure.TIM_Prescaler     = BSP_XLongPWM_GroupPara[21];
	TIM_TimeBaseStructure.TIM_CounterMode   = ((uint16_t)0x0000);        
	TIM_TimeBaseStructure.TIM_Period        = BSP_XLongPWM_GroupPara[22];
	TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);              
	TIM_TimeBaseInit(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400)),&TIM_TimeBaseStructure);	

	
	TIM_TimeBaseStructure.TIM_Prescaler     = BSP_XLongPWM_GroupPara[24];
	TIM_TimeBaseStructure.TIM_CounterMode   = ((uint16_t)0x0000);        
	TIM_TimeBaseStructure.TIM_Period        = BSP_XLongPWM_GroupPara[25];
	TIM_TimeBaseStructure.TIM_ClockDivision = ((uint16_t)0x0000);              
	TIM_TimeBaseInit(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800)),&TIM_TimeBaseStructure);	
	...
	TIM_OC1Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)),  &TIM_OCInitStructure);                          
	TIM_OC2Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)),  &TIM_OCInitStructure);                          
	TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), &TIM_OCInitStructure);                          
	TIM_OC2Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), &TIM_OCInitStructure);                          
	TIM_OC1Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)),  &TIM_OCInitStructure);                          
	TIM_OC2Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)),  &TIM_OCInitStructure);                          
	TIM_OC3Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)),  &TIM_OCInitStructure);                          
	...
	TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), &TIM_OCInitStructure);                          
	TIM_OC1Init(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), &TIM_OCInitStructure);                          
	TIM_OC1Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400)), &TIM_OCInitStructure);                          
	TIM_OC1Init(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800)), &TIM_OCInitStructure);                          
	...
	TIM_OC1PreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)), ((uint16_t)0x0008));                  
    TIM_ARRPreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)), ENABLE);                                
	...
	TIM_OC1PreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), ((uint16_t)0x0008));                 
    TIM_ARRPreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), ENABLE);                               
	TIM_OC1PreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), ((uint16_t)0x0008));                 
    TIM_ARRPreloadConfig(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), ENABLE);                               
	TIM_OC1PreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400)), ((uint16_t)0x0008));                 
    TIM_ARRPreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400)), ENABLE);                               
	TIM_OC1PreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800)), ((uint16_t)0x0008));                 
    TIM_ARRPreloadConfig(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800)), ENABLE);                               

	TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)), ENABLE);                                             
    TIM_Cmd(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)), ENABLE);                                             
    ...
    TIM_Cmd(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), ENABLE);                                            
    TIM_Cmd(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400)), ENABLE);                                            
    TIM_Cmd(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800)), ENABLE);                                            
	...
	TIM_SetCompare3(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),  15000);	   
	TIM_SetCompare4(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),  15000);	   
	TIM_SetCompare1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),  15000);     
	TIM_SetCompare2(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0400)),  15000);     
	
	TIM_SetCompare1(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)),  15000);     
	TIM_SetCompare2(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4000)),  15000);     
	
	TIM_SetCompare1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), 15000);     
	TIM_SetCompare2(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1800)), 15000);     
	
	TIM_SetCompare1(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)),  24000);     
	TIM_SetCompare2(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)),  24000);     
	TIM_SetCompare3(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)),  24000);	   
	TIM_SetCompare4(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x0000)),  24000);	   
	
	TIM_SetCompare1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)),  24000);     
	TIM_SetCompare2(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)),  24000);     
	TIM_SetCompare3(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)),  24000);	   
	TIM_SetCompare4(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0800)),  24000);	   
	
	
	TIM_SetCompare1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x2000)), 54000);	   
	
	
	TIM_SetCompare1(((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x1C00)), 54000);	   

	
	TIM_SetCompare1(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4400)), 12000);	   

	
	TIM_SetCompare1(((TIM_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x4800)), 12000);	   
} 
