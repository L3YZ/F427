#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tick.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tick.c"
...
void  OS_TickTaskInit (OS_ERR  *p_err)
{
#line 127 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_tick.c"
                            ...
                            OS_ERR   *p_err)
{
    ...
    if (opt == ((OS_OPT)0x04u)) {                                      
        ...
        if ((remain > (OS_TICK)(((((((sizeof(OS_TICK) * 8u) / 2u)) >= (4u * 8u)) ? (4294967295u) : ((1u << (((sizeof(OS_TICK) * 8u) / 2u))) - 1uL)) << (((sizeof(OS_TICK) * 8u) / 2u))))) ||                                 
            (remain == (OS_TICK)0u)) {
        ...
        if ((OSTickCtr - p_tcb->TickCtrPrev) > time) {
            ...
            if ((remain > (OS_TICK)(((((((sizeof(OS_TICK) * 8u) / 2u)) >= (4u * 8u)) ? (4294967295u) : ((1u << (((sizeof(OS_TICK) * 8u) / 2u))) - 1uL)) << (((sizeof(OS_TICK) * 8u) / 2u))))) ||                             
                (remain == (OS_TICK)0u)) {
                p_tcb->TickCtrPrev += time + time * ((OSTickCtr - p_tcb->TickCtrPrev) / time);  
                p_tcb->TickRemain   = (OS_TICK)0u;
               *p_err               =  OS_ERR_TIME_ZERO_DLY;             
                return;
            }
...
static  CPU_TS  OS_TickListUpdateDly (void)
{
    ...
    if (p_tcb != (OS_TCB *)0) {
        ...
        while (p_tcb->TickRemain == 0u) {
            ...
            if (p_tcb->TaskState == (OS_STATE)( 1u)) {
                p_tcb->TaskState = (OS_STATE)( 0u);
                OS_RdyListInsert(p_tcb);                                 
            } else if (p_tcb->TaskState == (OS_STATE)( 5u)) {
    ...
    ts_delta_dly       = (CPU_TS)CPU_TS_TmrRd() - ts_start;                         
    do { do { CPU_SR_Restore(cpu_sr); } while (0); } while (0);
...
static  CPU_TS  OS_TickListUpdateTimeout (void)
{
    ...
    if (p_tcb != (OS_TCB *)0) {
        ...
        while (p_tcb->TickRemain == 0u) {
            ...
            p_tcb->TS      = (CPU_TS)CPU_TS_TmrRd();
            OS_PendListRemove(p_tcb);                                    
            if (p_tcb->TaskState == (OS_STATE)( 3u)) {
                OS_RdyListInsert(p_tcb);                                 
                p_tcb->TaskState  = (OS_STATE)( 0u);
            } else if (p_tcb->TaskState == (OS_STATE)( 7u)) {

                p_tcb->TaskState  = (OS_STATE)( 4u);
            }
            p_tcb->PendStatus = (OS_STATUS)( 3u);                  
    ...
    ts_delta_timeout   = (CPU_TS)CPU_TS_TmrRd() - ts_start;                         
    do { do { CPU_SR_Restore(cpu_sr); } while (0); } while (0);                                                  
