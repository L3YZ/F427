#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_msg.c"
...
#line 37 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_msg.c"
...
#line 78 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_msg.c"
...
#line 227 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_msg.c"
...
#line 313 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_msg.c"
    ...
    if (p_msg_q->NbrEntries == (OS_MSG_QTY)0) {              
        ...
        if ((opt & (OS_OPT)(0x0010u)) == (OS_OPT)(0x0000u)) {  
            p_msg_in           = p_msg_q->InPtr;             
            p_msg_in->NextPtr  = p_msg;
            p_msg_q->InPtr     = p_msg;
            p_msg->NextPtr     = (OS_MSG *)0;
        } else {
            p_msg->NextPtr     = p_msg_q->OutPtr;            
            p_msg_q->OutPtr    = p_msg;
        }
        p_msg_q->NbrEntries++;
    }
