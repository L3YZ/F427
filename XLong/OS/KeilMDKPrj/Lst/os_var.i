#line 1 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_var.c"
...
extern            CPU_DATA                  OSPrioTbl[((64u - 1u) / ((4u * 8u)) + 1u)];
            ...
            CPU_BOOLEAN               OSStatResetFlag;             
            OS_CPU_USAGE              OSStatTaskCPUUsage;          
            OS_CPU_USAGE              OSStatTaskCPUUsageMax;       
            OS_TICK                   OSStatTaskCtr;
            OS_TICK                   OSStatTaskCtrMax;
            OS_TICK                   OSStatTaskCtrRun;
            CPU_BOOLEAN               OSStatTaskRdy;
            OS_TCB                    OSStatTaskTCB;
            CPU_TS                    OSStatTaskTimeMax;
            ...
            OS_TICK_LIST              OSTickListDly;
            OS_TICK_LIST              OSTickListTimeout;





            OS_TMR                   *OSTmrDbgListPtr;

            OS_OBJ_QTY                OSTmrListEntries;            
            OS_TMR                   *OSTmrListPtr;
            ...
            OS_TICK                   OSTmrTickCtr;                
            OS_CTR                    OSTmrUpdateCnt;              
            OS_CTR                    OSTmrUpdateCtr;
...
#line 39 "..\\..\\..\\uCOS\\uCOS-III\\Source\\os_var.c"
