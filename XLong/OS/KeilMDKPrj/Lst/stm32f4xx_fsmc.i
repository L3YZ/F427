#line 1 "..\\..\\BSP\\STM32F4xx\\src\\stm32f4xx_fsmc.c"
...
#line 1 "..\\..\\BSP\\STM32F4xx\\inc\\stm32f4xx_fsmc.h"
...
#line 39 "..\\..\\BSP\\STM32F4xx\\inc\\stm32f4xx_fsmc.h"
...
#line 314 "..\\..\\BSP\\STM32F4xx\\inc\\stm32f4xx_fsmc.h"
...
#line 491 "..\\..\\BSP\\STM32F4xx\\inc\\stm32f4xx_fsmc.h"
...
#line 541 "..\\..\\BSP\\STM32F4xx\\inc\\stm32f4xx_fsmc.h"
...
#line 603 "..\\..\\BSP\\STM32F4xx\\inc\\stm32f4xx_fsmc.h"
...
#line 618 "..\\..\\BSP\\STM32F4xx\\inc\\stm32f4xx_fsmc.h"
...
#line 36 "..\\..\\BSP\\STM32F4xx\\src\\stm32f4xx_fsmc.c"
#line 37 "..\\..\\BSP\\STM32F4xx\\src\\stm32f4xx_fsmc.c"
...
{ 
  ...
  {
    FSMC_Bank1->BTCR[FSMC_NORSRAMInitStruct->FSMC_Bank] |= (uint32_t)((uint32_t)0x00000040);
  }
...
void FSMC_NORSRAMCmd(uint32_t FSMC_Bank, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    FSMC_Bank1->BTCR[FSMC_Bank] |= ((uint32_t)0x00000001);
  }
  else
  {
     
    FSMC_Bank1->BTCR[FSMC_Bank] &= ((uint32_t)0x000FFFFE);
  }
}
...
void FSMC_NANDCmd(uint32_t FSMC_Bank, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    if(FSMC_Bank == ((uint32_t)0x00000010))
    {
      FSMC_Bank2->PCR2 |= ((uint32_t)0x00000004);
    }
    else
    {
      FSMC_Bank3->PCR3 |= ((uint32_t)0x00000004);
    }
  }
  else
  {
    ...
    if(FSMC_Bank == ((uint32_t)0x00000010))
    {
      FSMC_Bank2->PCR2 &= ((uint32_t)0x000FFFFB);
    }
    else
    {
      FSMC_Bank3->PCR3 &= ((uint32_t)0x000FFFFB);
    }
  }
}
...
void FSMC_NANDECCCmd(uint32_t FSMC_Bank, FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    if(FSMC_Bank == ((uint32_t)0x00000010))
    {
      FSMC_Bank2->PCR2 |= ((uint32_t)0x00000040);
    }
    else
    {
      FSMC_Bank3->PCR3 |= ((uint32_t)0x00000040);
    }
  }
  else
  {
    ...
    if(FSMC_Bank == ((uint32_t)0x00000010))
    {
      FSMC_Bank2->PCR2 &= ((uint32_t)0x000FFFBF);
    }
    else
    {
      FSMC_Bank3->PCR3 &= ((uint32_t)0x000FFFBF);
    }
  }
}
...
void FSMC_PCCARDCmd(FunctionalState NewState)
{
  ...
  if (NewState != DISABLE)
  {
    ...
    FSMC_Bank4->PCR4 |= ((uint32_t)0x00000004);
  }
  else
  {
     
    FSMC_Bank4->PCR4 &= ((uint32_t)0x000FFFFB);
  }
}
