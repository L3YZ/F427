#line 1 "..\\..\\BSP\\Board\\src\\bsp_periph.c"
...
#line 38 "..\\..\\BSP\\Board\\src\\bsp_periph.c"
...
#line 53 "..\\..\\BSP\\Board\\src\\bsp_periph.c"
...
CPU_INT32U  BSP_PeriphClkFreqGet (CPU_DATA  pwr_clk_id)
{
    ...
    switch (pwr_clk_id) {
        ...
        case 126u:
        case 127u:
             clk_div = ((*(CPU_REG32 *)(0x40023800 + 0x008)) & 0x00001C00) >> 10;
             if (clk_div < 4) {
                 return (clk_freq);
             }
             clk_div   = (clk_div - 3) << 1;
        ...
        case 150u:
        case 154u:
             clk_div = ((*(CPU_REG32 *)(0x40023800 + 0x008)) & 0x000E000) >> 13;
             if (clk_div < 4) {
                 return (clk_freq);
             }
             clk_div   = (clk_div - 3) << 1;
...
void  BSP_PeriphEn (CPU_DATA  pwr_clk_id)
{
    switch (pwr_clk_id) {
        ...
        case 29u:
        case 30u:
             (*(CPU_REG32 *)(0x40023800 + 0x030)) |= (1u << (pwr_clk_id));
             break;
        ...
        case 38u:
        case 39u:
             (*(CPU_REG32 *)(0x40023800 + 0x034)) |= (1u << (pwr_clk_id - 32));
             break;

        case 64u:
             (*(CPU_REG32 *)(0x40023800 + 0x038)) |= (1u << (pwr_clk_id - 64));
             break;
        ...
        case 126u:
        case 127u:
             (*(CPU_REG32 *)(0x40023800 + 0x040)) |= (1u << (pwr_clk_id - 96));
             break;
        ...
        case 150u:
        case 154u:
             (*(CPU_REG32 *)(0x40023800 + 0x044)) |= (1u << (pwr_clk_id - 128));
             break;
    }
}
